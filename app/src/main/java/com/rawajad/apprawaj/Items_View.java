...
public class Items_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_items__view);

        recyclerView=(RecyclerView)findViewById(R.id.rvRecycler_View);
        ...
        AsyncTask<Integer,Void,Void>task =new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                Request request = new Request.Builder()
                        //TODO pass the URL here
                        .url("http://192.168.1.152/cobonat/script.php?id="+id)
                        .build();
                try {
